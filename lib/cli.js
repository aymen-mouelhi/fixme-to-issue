...
try {
  ...
  console.log(`File .fixme-to-issue doesn't exist`);
} finally {
...
var username = argv.username || argv.u || fixmeOptions.github.username;
if (username) {
  options.username = username;
}

var password = argv.password || argv.p || fixmeOptions.github.password;
if (password) {
