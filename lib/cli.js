...
var username = argv.username || argv.u || fixmeOptions.github ? fixmeOptions.github.username : null;
if (username) {
  options.github.username = username;
}

var password = argv.password || argv.p || fixmeOptions.github ? fixmeOptions.github.password : null;
if (password) {
  options.github.password = password;
}

// Custom labels [Issue #86]
...
// Set prefix
var prefix = argv.prefix || argv.prefix;
