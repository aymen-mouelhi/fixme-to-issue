...
class Github {
    ...
    createIssue(message) {
        // TODO Labels should contact the default prefix option [Issue #108]
        // TODO Label colors? [Issue #110]
        var labels = ["Bot"];
        var self = this;
        ...
        return new Promise(function(resolve, reject) {
          ...
          if(issue){
            ...
            // TODO: Opened Issue should mention that it is generated by the bot (or add label generated by bot) [Issue #105]
