...
class Github {
    ...
    createIssue(message) {
        ...
        return new Promise(function(resolve, reject) {
          console.log(`Create Issue url: ${GITHUB_API_URL}/repos/${self.author}/${self.repository}/issues`)
          axios.post(`${GITHUB_API_URL}/repos/${self.author}/${self.repository}/issues`, {
              ...
              .catch(function(error) {
                  console.log('Error post to issues:  ' + error);
                  reject(error);
              });
        });
    }
