      ...
      return new Promise(function(resolve, reject) {
        ...
        axios.get(`${GITHUB_API_URL}/${self.author}/${self.repository}/issues?state=all&per_page=100`)
          .then(function(response) {
            ...
            console.log(chalk.yellow(`Getting ${self.repository} Issues ...`));
    ...
    createIssue(message) {
        ...
        return new Promise(function(resolve, reject) {
          ...
          if(issue){
            ...
            // FIXME Remove dummy description, try to insert file + line number
            // TODO: Opened Issue should mention that it is generated by the bot (or add label generated by bot)
