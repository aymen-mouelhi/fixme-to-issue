...
class Github {
    constructor(options) {
        // TODO: Emit event when github ready
    ...
    createIssue(message) {
        //FIXME there is an issue in lables: one item can have multiple same Labels(todos, todos, todos)
        ...
        var self = this;
        return new Promise(function(resolve, reject) {
          var issue = this.issueExists(message);
